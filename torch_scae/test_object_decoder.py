...
from torch_scae.object_decoder import CapsuleLayer, CapsuleLikelihood
...
class CapsuleLayerTestCase(unittest.TestCase):
    def test_capsule_layer(self):
        ...
        self.assertTrue(
            result.raw_caps_params.shape == (B, O, H)
        )
        self.assertTrue(
            result.raw_caps_features.shape == features.shape
        )
...
class CapsuleLikelihoodTestCase(unittest.TestCase):
    def test_capsule_likelihood(self):
        ...
        self.assertTrue(
            result.winner_pres.shape == (B, V)
        )
        self.assertTrue(
            result.soft_winner.shape == (B, V, P)
        )
        self.assertTrue(
            result.soft_winner_pres.shape == (B, V)
        )
        self.assertTrue(
            result.posterior_mixing_probs.shape == (B, V, O)
        )
        self.assertTrue(
            result.mixing_logits.shape == (B, O + 1, V)
        )
        self.assertTrue(
